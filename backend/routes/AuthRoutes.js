...
import { Institution_login  , organization_login , organization_register, getInstitutionDetails} from "../controllers/AuthController.js";
...
router.get("/institution-details/:email", getInstitutionDetails);
